...
- 大小切换：在悬浮窗上右键，选择 `大小 / Size`，可以切换小、中、大三档。
- 图案资源：悬浮窗使用 `assets/traffic-light-颜色-大小.png` 这组三档 PNG 图片切换状态。
...
- Size switch: right-click the floating window, open `Size / 大小`, and choose Small, Medium, or Large.
- Image assets: the floating window switches between the three-size `assets/traffic-light-color-size.png` PNG set.
